...
//     } else {
//         console.log('Couldn\'nt connect to MySql.\n');
//     }
// });
...
const address = "0xd0a2abd8788902F9F1D6688555bb5248794776e9";
// const contract = web3.eth.contract(abiArray);
var contract = new web3.eth.Contract(abiArray, address);
...
var custno = 1;
var custs = [];
app.post('/selltocustomer', (req, res) => {
	var name = req.body.name;
	var email = req.body.email;
	var code = req.body.code;
	custs.push({"name": name, "email" : email, "code ": code, "customer index" : custno});
	custno += 1;
...
app.get('/getdetails', (req, res) => {
	var code = req.body.code;
	res.status(201).send(`Details for the code ${code}` + "  " + "Nike Jordan" + " " +JSON.stringify(custs));
});
/**
